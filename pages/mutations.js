...
import { addSuperHeroes, getSuperHeroes } from "../customHooks/useSuperHeroesMutations";
...
export default function mutations() {
  ...
  const submitHandler = () => {
    if (superheroName && alterEgoName) {
      const hero = { name: superheroName, alterEgo: alterEgoName };
      mutateResult.mutate(hero);
      setSuperheroName(undefined);
      setAlterEgoName(undefined);
    }
  };
