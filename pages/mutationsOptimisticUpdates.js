...
import {
  addOptimisticSuperHeroes,
  getSuperHeroes,
} from "../customHooks/useSuperHeroesMutations";

export default function mutationsOptimisticUpdates() {
  ...
  return (
    <div>
      ...
      >
        ...
        <form>
          <FormControl m={2}>
            <FormLabel htmlFor="superhero" id="superhero-label">
              Superhero Name{" "}
            </FormLabel>
            <Input
              id="superhero"
          ...
          <FormControl m={2}>
            <FormLabel htmlFor="alterEgo" id="alterEgo-label">
              AlterEgo Name{" "}
            </FormLabel>
            <Input
              name="alterEgo"
          ...
          <Button
            ...
            isLoading={mutateResult.isLoading || mutateResult.isFetching}
          >
            {(mutateResult.isIdle && "submit") ||
              (mutateResult.isSuccess && "Done") ||
              (mutateResult.isError && "Try Again")}
          </Button>
        </form>
      </Box>
    </div>
